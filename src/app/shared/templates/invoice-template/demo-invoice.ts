          ...
          columns: [
            {
              stack: [
                ...
                {
                  text: `${invoiceData?.companyDetails?.customer?.name ||
                        ...
                        },
                        {
                          columns: [
                            ...
                            },
                            {
                              stack: [
                                {
                                  text: `${invoiceData?.invoiceDueDate
                                    ? moment(
          ...
          [
                      ...
                      stack: [
                        {
                          text: [
                            ...
                            `${invoiceData?.shipmentDetails?.jobid}`,
                          ],
                          fontSize: 10,
                          alignment: `left`,
                        },
                  ...
                  columns: [
                    {
                      stack: [
                        {
                          text: [
                            { text: `VCN No. : `, bold: true },
                            `${invoiceData?.shipmentDetails?.vcn || ''}`,
                          ],
                          fontSize: 10,
                          alignment: `left`,
                        },
                  ...
                  columns: [
                    {
                      stack: [
                        {
                          text: [
                            { text: `Ship name : `, bold: true },
                            `${invoiceData?.shipmentDetails?.shipname || ''}`,
                          ],
                          fontSize: 10,
                          alignment: `left`,
                        },
            ...
            {},
            {
              ...
              stack: [
                ...
                //     `${invoiceData?.shipmentDetails?.destinationPortName ?? ""} ${invoiceData?.shipmentDetails?.portCode ? "(" : ""} ${invoiceData?.shipmentDetails?.portCode ?? ""}${invoiceData?.shipmentDetails?.portCode ? ")" : ""}`,
                //   ],
                //   fontSize: 10,
                //   alignment: `left`,
                // },
          ...
          .concat(
            ...
            invoiceData?.rateDetails?.invoiceItems.map((item: any, index: any) => {
              ...
              const igstAmt =
                ...
                100;
              const totItemVal =
                Number(item?.total_amount) + Number(igstAmt);
              this.totalItemValue += totItemVal;
              return [
                { text: `${index + 1}`, fontSize: 8 },
                { text: item?.service_sub_type, fontSize: 8 },
                { text: item?.unit_name, fontSize: 8 },
                { text: "INR", fontSize: 8 },
                {
                ...
                {
                  text: this.numberFormat(Number(item?.total_amount)),
                  fontSize: 8,
                },
                ...
                {
                  text: this.numberFormat(totItemVal + (totItemVal * 0.18)),
                  alignment: `right`,
                  fontSize: 8,
                },
              ];
                ...
                stack: [
                  {
                    columns: [
                      ...
                      },
                      {
                        stack: [
                          {
                            text: invoiceData?.rateDetails?.nontaxableamount,
                            fontSize: 10,
                            alignment: `right`,
                          },
                        ],
                        ...
                        stack: [
                          {
                            ...
                            //   )
                            // ),
                            text: (invoiceData?.rateDetails?.nontaxableamount * 0.18),
                            fontSize: 10,
                            alignment: `right`,
                          },
                        ],
                    ...
                    columns: [
                      ...
                      },
                      {
                        stack: [
                          {
                            text: this.numberFormat(
                              Number(invoiceData?.rateDetails?.nontaxableamount * 0.18) + Number(invoiceData?.rateDetails?.nontaxableamount)
                            ),
                            fontSize: 10,
                            alignment: `right`,
                          },
            ...
            [
              {
                ...
                stack: [
                  {
                    text: `Remark : ${invoiceData?.shipmentDetails?.remark || ''} `,
                    fontSize: 10,
                    alignment: `left`,
                    bold: true,
                  },
