...
export const ProgressBarsStriped: progress[] = [
    {
        ...
        item: [
            ...
            {
                value: '50%',
                class: 'progress-bar progress-bar-striped bg-tertiary'
            },
            {
                value: '75%',
...
export const ProgressBarsAnimated: progress[] = [
    {
        ...
        item: [
            ...
            {
                value: '50%',
                class: 'progress-bar-animated progress-bar-striped bg-tertiary'
            },
            {
                value: '75%',
...
export const Multiplebars = [
    {
        ...
        title: 'Include multiple progress bars in a progress component if you need to apply a stripe via CSS gradient over</span><code></code><span>the progress bars background color Using CSS Effects.',
        item: [
            {
                value: '30%',
                class: 'progress-bar bg-primary'
...
export const CustomProgressbars = [
    ...
    {
        value: '60%',
        class: ' progress-bar-animated progress-bar-striped bg-secondary text-center',
        text: '60% Getting Pause...'
    },
    {
        value: '70%',
        class: ' progress-bar-animated progress-bar-striped bg-tertiary text-center',
        text: '70% Getting Uploading....'
    },
    {
        value: '100%',
        class: ' progress-bar-animated progress-bar-striped bg-success text-center',
        text: '100% Completed'
    },
];
