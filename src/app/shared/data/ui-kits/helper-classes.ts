...
export const TextColor = [
    {
        ...
        item: [
            {
                text: 'c',
                class: 'helper-box helper-text border font-primary',
                title: '.font-primary'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-secondary',
                title: '.font-secondary'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-success',
                title: '.font-success'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-danger',
                title: '.font-danger'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-warning',
                title: '.font-warning'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-info',
                title: '.font-info'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-dark',
                title: '.font-dark'
            },
            {
                text: 'c',
                class: 'helper-box helper-text border font-light bg-dark',
                title: '.font-light'
            },
        ]
    }
...
export const AdditiveBorderData: titleData[] = [
    {
        ...
        item: [
            {
                class: 'helper-box bg-light solid-border',
                title: '.border'
            },
            {
