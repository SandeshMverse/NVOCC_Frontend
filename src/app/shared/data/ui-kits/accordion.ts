...
export const FlushAccordion = [
    {
        ...
        title: 'Flush accordion Item #1',
        list: "Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the first item&apos;s accordion body. Let's imagine this being filled with some actual content. that use for remove default border and background colors.",
     
    },
    {
        panel: 'Second',
        class: 'bg-light-success ',
        title: 'Flush accordion Item #2',
        list: "Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the second item&apos;s accordion body. Let&apos;s imagine this being filled with some actual content.",

    },
    {
        panel: 'Third',
        class: 'bg-light-success ',
        title: 'Flush accordion Item #3',
        list: "Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the third item&apos;s accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.",
