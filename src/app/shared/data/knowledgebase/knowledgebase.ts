...
export const knowledgebaseData: knowledgebase[] = [
   ...
   },
   {
      title: 'Knowledgebase',
      colClass: 'col-sm-6',
      desc: "A Website Designing course enables learners to use essential and designing and programming tools required to do the job. The curriculum is a not a blend of various themes.",
      icon: 'aperture'
   },
   {
      title: 'Support',
