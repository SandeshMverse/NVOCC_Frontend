export const commonBorderPositionCardData = [
    {
        id : 1,
        borderClass : 'b-l-primary border-bottom',
        heading : 'Border Left',
        desc : 'Use the class of<code>.b-l-* </code>for left border.',
        bodyText : "Us Technology offers web & mobile development solutions for all industry verticals.Include a short form using fields that'll help your business understand who's contacting them.<br><strong>Visit Us: </strong>	2600 Hollywood Blvd,Florida, United States-	33020<br><strong>Mail Us:</strong>contact@us@gmail.com<br><strong>Contact Number: </strong>(954) 357-7760",
    },
    {
        id : 2,
        borderClass : 'b-r-secondary border-bottom',
    ...
    {
        id : 3,
        borderClass : 'b-t-tertiary border-bottom',
        heading : 'Border Top',
        desc : 'Use the class of<code>.b-t-* </code>for top border.',
        bodyTextClass : 'mb-0 mt-1',
...
export const primaryStateCardData = [
    {
...
export const warningStateCardData = [
    {
        colorClass : 'primary',
...
export const secondaryStateCardData = [
    {
        name : 'Stella Nowland',
        badgeColor : 'warning',
        badgeText : 'Freelance',
...
export const commonAbsoluteCardData = [
    {
        bgColor : 'secondary',
