...
export const monthlyHistoryData: ChartOptions | any = {
    ...
    colors: [secondary_color, tertiary_color, primary_color],
    fill: {
        type: "gradient",
        gradient: {
            shade: "light",
...
export const SkillStatus: ChartOptions | any = {
    ...
    colors: [secondary_color, primary_color, tertiary_color],
    responsive: [{
        breakpoint: 767,
        options: {
            title: {
...
export const Progress3: ChartOptions | any = {
    ...
    plotOptions: {
        bar: {
            ...
            barHeight: "15%",
            colors: {
                backgroundBarColors: [tertiary_color],
                backgroundBarOpacity: 0.2,
                backgroundBarRadius: 10,
            },
        },
    ...
    fill: {
        ...
        type: "gradient",
        gradient: {
            gradientToColors: [tertiary_color],
        },
    },
    title: {
        floating: true,
