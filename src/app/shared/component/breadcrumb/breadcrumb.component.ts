...
export class BreadcrumbComponent {
  ...
  public breadcrumbs: { parentBreadcrumb?: string | null; childBreadcrumb?: string;  parenttitle?: string | null;} | undefined;
  public title: string = ''
  ...
  constructor(private activatedRoute: ActivatedRoute,
    ...
    this.router.events
      ...
      .subscribe(route => {
        ...
        let parenttitle = route.parent?.snapshot.data['title'];
